...
public class ActCoManMent extends BaseAct {
    ...
    public int getContentViewId() {
        return R.layout.activity_act_co_man_ment;
    }
    ...
    static class BasePagerAdapter extends FragmentPagerAdapter {
        String[] titles = new String[]{"出售中", "已下架"};
        ...
        public Fragment getItem(int position) {
            return FragmentFactory.ComAnagement(position);
        }
