...
public class ActReCenter extends BaseAct {
    ...
    @BindView(R.id.xre_re)
    MyXrecycleview xre_re;
    ...
    public int getContentViewId() {
        return R.layout.activity_act_re_center;
    }
    ...
    public void initData() {
        ...
        xre_re.setAdapter(myRecycleViewAdapter);

        xre_re.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
