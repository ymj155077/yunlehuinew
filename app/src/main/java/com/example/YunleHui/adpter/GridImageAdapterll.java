 ...
 * data：16/7/27
 */
public class GridImageAdapterll extends
        RecyclerView.Adapter<GridImageAdapterll.ViewHolder> {
    ...
    public GridImageAdapterll(Context context, onAddPicClickListener mOnAddPicClickListener) {
