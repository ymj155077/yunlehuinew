 ...
 * data：19/7/27
 */
public class GridPublishGoods extends
        RecyclerView.Adapter<GridPublishGoods.ViewHolder> {
    ...
    public GridPublishGoods(Context context, onAddPicClickListener mOnAddPicClickListener) {
