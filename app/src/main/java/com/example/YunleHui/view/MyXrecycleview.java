 ...
 * on 2019/7/17 0017
 */
public class MyXrecycleview extends RecyclerView {
    ...
    private final AdapterDataObserver mDataObserver = new MyXrecycleview.DataObserver();
    ...
    public MyXrecycleview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyXrecycleview(Context context, AttributeSet attrs, int defStyle) {
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    MyXrecycleview.this.setVisibility(View.GONE);
                } else {
                    mEmptyView.setVisibility(View.GONE);
                    MyXrecycleview.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    public void setScrollAlphaChangeListener(
            XRecyclerView.ScrollAlphaChangeListener scrollAlphaChangeListener
    ){
