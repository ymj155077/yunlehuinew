...
public abstract class CommonAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    protected ArrayList<Bean_cityList.DataBean> mDatas;
    ...
    public CommonAdapter(Context context, int layoutId, ArrayList<Bean_cityList.DataBean> datas) {
        mContext = context;
...
//    HeaderAndFooterWrapperAdapter
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        convert(holder,mDatas.get(position).getCityName(),mDatas.get(position).getId());
    }
    ...
    public abstract void convert(ViewHolder holder, String name,int Id);
     ...
     * @param list
     */
    public void setDatas(ArrayList<Bean_cityList.DataBean> list) {
        if (this.mDatas != null) {
            if (null != list) {
                ArrayList<Bean_cityList.DataBean> temp = new ArrayList<>();
                temp.addAll(list);
                this.mDatas.clear();
     ...
     * @param list
     */
    public void addDatas(ArrayList<Bean_cityList.DataBean> list) {
        if (null != list) {
            ArrayList<Bean_cityList.DataBean> temp = new ArrayList<>();
            temp.addAll(list);
            if (this.mDatas != null) {
    ...
    public ArrayList<Bean_cityList.DataBean> getDatas() {
        return mDatas;
    }


    public Bean_cityList.DataBean getItem(int position) {
